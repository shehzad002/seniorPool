...
import "./IgoflamingoConfig.sol";
import "./ConfigOptions.sol";

/**
 * @title goflamingoConfig
...
contract goflamingoConfig is BaseUpgradeablePausable {
  ...
  function setgoflamingoConfig(address newAddress) public onlyAdmin {
    uint256 key = uint256(ConfigOptions.Addresses.goflamingoConfig);
    emit AddressUpdated(msg.sender, key, addresses[key], newAddress);
    addresses[key] = newAddress;
  }
  ...
  function initializeFromOtherConfig(
    ...
    IgoflamingoConfig initialConfig = IgoflamingoConfig(_initialConfig);
